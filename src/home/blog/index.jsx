              ...
              <div class="col-md-6 col-sm-6 col-lg-4">
                <div class="post-box w-100">
                  ...
                  <div class="post-info position-relative w-100">
                    <a class="thm-bg" href="blog-detail.html" title="">
                    ...
                    <ul class="post-meta d-flex flex-wrap mb-0 list-unstyled">
                      ...
                      <li>
                        <i class="fas fa-comment-alt"></i>1 Comments
                      </li>
                    </ul>
                  </div>
                </div>
                ...
                <div class="post-box w-100">
                  ...
                  <div class="post-info position-relative w-100">
                    ...
                    <ul class="post-meta d-flex flex-wrap mb-0 list-unstyled">
                      ...
                      <li>
                        <i class="fas fa-comment-alt"></i>5 Comments
                      </li>
                    </ul>
                  </div>
                </div>
                ...
                <div class="post-box w-100">
                  ...
                  <div class="post-info position-relative w-100">
                    ...
                    <ul class="post-meta d-flex flex-wrap mb-0 list-unstyled">
                      ...
                      <li>
                        <i class="fas fa-comment-alt"></i>15 Comments
                      </li>
                    </ul>
                  </div>
                </div>
